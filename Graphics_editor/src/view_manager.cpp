...
void View_manager::fill_tool_manager() {
	...
	pencil = new Pencil(left_corner, 50, 50, Tool_manager::get_tool_manager()->get_ptr_to_pen_colour(), Widget_types::TOOL, PATH_TO_PICTURE_WITH_PENCIL);
	...
	plugin_tool->texture->add_new_texture(PATH_TO_PICTURE_WITH_HELP_BUTTON);
