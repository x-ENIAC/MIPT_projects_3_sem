...
int main() {
	...
	Molecule m2( Point(rand() % FIELD_WIDTH, rand() % FIELD_HEIGHT), rand() % 20, 1, rand() % 10, rand() % 10, 
	...
	Molecule m3( Point(rand() % FIELD_WIDTH, rand() % FIELD_HEIGHT), rand() % 20, 1, rand() % 10, rand() % 10, 
																	 Colour(0, rand() % 255, rand() % 255, 255), CIRCLE, true );
	...
	Rectangle r2( Point(rand() % FIELD_WIDTH, rand() % FIELD_HEIGHT), 1, rand() % 30,      rand() % 30,
																	     Colour(rand() % 255, rand() % 255, rand() % 255, 255), 
																		 rand() % 20 + 10, rand() % 20 + 10, RECTANGLE, true );	
	shape_manager.add_object(&r2);

	//Rectangle r3( Point(0, 400), 1, -1, -1, Colour(121, 255, 0, 255), 30.0, 30.0, RECTANGLE, true );
	Rectangle r3( Point(rand() % FIELD_WIDTH, rand() % FIELD_HEIGHT), 1, rand() % 30,      rand() % 30,
																	     Colour(rand() % 255, rand() % 255, rand() % 255, 255), 
																		 rand() % 20 + 10, rand() % 20 + 10, RECTANGLE, true );	
	shape_manager.add_object(&r3);

	//Rectangle r4( Point(600, 300), 1, -3, 8, Colour(90, 123, 12, 255), 30.0, 30.0, RECTANGLE, true );
	Rectangle r4( Point(rand() % FIELD_WIDTH, rand() % FIELD_HEIGHT), 1, rand() % 30,      rand() % 30, 
																		 Colour(rand() % 255, rand() % 255, rand() % 255, 255), 
																		 rand() % 20 + 10, rand() % 20 + 10, RECTANGLE, true );	
	...
	while(is_run) {
		while(SDL_PollEvent(&event)) {
			if(event.type == SDL_QUIT)
				...
				button_manager.check_events(&event, &shape_manager);        
		}

		shape_manager.update_molecule();
		shape_manager.collision_detection(FIELD_WIDTH, FIELD_HEIGHT);
